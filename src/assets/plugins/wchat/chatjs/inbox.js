...
var audioogg = new Audio('../../plugins/wchat/audio/chat.ogg');
var audiomp3 = new Audio('../../plugins/wchat/audio/chat.mp3');
...
function checkChatBoxInputKey(event,chatboxtextarea,chatboxtitle,toid,img,send) {
    ...
    if((event.keyCode == 13 && event.shiftKey == 0) || (send == 1))  {
        ...
        if (message != '') {
            ...
            '<img alt="'+username+'" src="../../plugins/wchat/storage/user_image/'+Ses_img+'">' +
            '</div>' +
            '<div class="chat-body">' +
            '<div class="chat-text">' +
            '<h4>'+username+'</h4>' +
...
$(document).ready(function() {
    $("#launchProfile").click(function(){
        ...
        var profileTpl = '<div class="">' +
            ...
            '<img class="thumb-lg img-circle" src="../../plugins/wchat/storage/user_image/'+img+'"></a>' +
